...
document.writeln(`<p title="найбільше число(1884214828412999)">Функція No1: ${getMaxDigit(1884214828412999)}</p><p title="піднесення числа X до степеня У(2 в 10 степ)"> Функція No2: ${number(2,10)}</p><p title="Зміна написання імені (sErHii)"> Функція No3: ${changeName("sErHii")}</p><p title="вираховує зарплату після сплати податків (29555, 27.4)"> Функція No4: ${purSalary(29555, 27.4)}</p><p title="рандомне число в N до M (0, 600)"> Функція No5: ${intRandom(0, 600)}</p><p  title="рахує кількість заданих літер в словосполученні"> Функція No6: ${countLetter('i have a dream haahahaha', 'h')}</p><p title="випадковий числовий пароль на 8 символів, або на ту кількість яку задасть користувач"> Функція No7: ${getRandomPassword(7)}</p><p title="конвертація гривні в долар і навпаки, помилка при задаванні іншої валюти"> Функція No8-9: ${exchangeMoney("100uah")}</p><p title="видаляє задану букву із заданого словосполучення ("l", 'latex lettrel laret llluli')"> Функція No10: ${delLetter("l", 'latex lettrel laret llluli')}</p><p title="перевіряє чи є рядок паліндромом ('Уже лисі ліси Лежу')"> Функція No11: ${palindromOrNot('Уже лисі ліси Лежу')} </p>`)
